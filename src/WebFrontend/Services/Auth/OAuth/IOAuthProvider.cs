...
public interface IOAuthProvider
{
    ...
    /// </summary>
    /// <param name="redirectUri">The callback URI where the provider should redirect after authentication</param>
    ...
    string BuildAuthorizationUrl(string redirectUri, string? returnUrl = null);
